...
namespace CosmosGettingStartedTutorial
{
    class Program
    {
        ...
        private string databaseName = "JnBDev";
        private string tableName = "DevItems";
        ...
        private async Task CreateContainerAsync()
        {
            ...
            this.container = await this.database.CreateContainerIfNotExistsAsync(tableName, "/partitionKey");
